...
7) **Campos y propiedades en inglés** — ERROR  
8) **Evitar repetición entre headers y body** — WARNING  
9) **Datos personales mínimos** — ERROR  
10) **Consistencia de tipos** — ERROR  
11) **Logs y mensajes de error sin datos personales** — ERROR  
12) **Sufijo 'Code' para campos de códigos** — ERROR  
13) **Nombres claros y evitar acrónimos** — WARNING  
